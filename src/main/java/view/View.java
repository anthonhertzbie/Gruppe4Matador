...
public class View extends Notifier {
    ...
    public GUI_Field[] gameBoardFields(){
        ...
        gui_fields[1] = new GUI_Street("Rødovrevej",helper.getFieldData(2,3) + "kr","","",Color.BLUE,Color.black);
        gui_fields[2] = new GUI_Chance();gui_fields[2].setSubText("Chance card");
        gui_fields[3] = new GUI_Street("Hvidovrevej",helper.getFieldData(4,3) + "kr","d","",Color.BLUE,Color.black);
        ...
        gui_fields[6] = new GUI_Street("Roskildevej",helper.getFieldData(7,3) + "kr","d","20",Color.ORANGE,Color.black);
        gui_fields[7] = new GUI_Chance();gui_fields[7].setSubText("Chance card");
        gui_fields[8] = new GUI_Street("Valby Langgade",helper.getFieldData(9,3) + "kr","d","20",Color.ORANGE,Color.black);
        gui_fields[9] = new GUI_Street("Allégade",helper.getFieldData(10,3) + "kr","d","20",Color.ORANGE,Color.black);
        ...
        gui_fields[15] = new GUI_Shipping("default",helper.getFieldData(16,3) + "kr","d","","20",Color.RED,Color.black);
        ...
        gui_fields[25] = new GUI_Shipping("default",helper.getFieldData(26,3) + "kr","d","","20",Color.BLUE,Color.BLACK);
        gui_fields[26] = new GUI_Street("t",helper.getFieldData(27,3) + "kr","d","20",Color.LIGHT_GRAY,Color.black);
        gui_fields[27] = new GUI_Street("t",helper.getFieldData(28,3) + "kr","d","20",Color.LIGHT_GRAY,Color.black);
        gui_fields[28] = new GUI_Brewery("default",helper.getFieldData(29,3) + "kr","d","","20",Color.RED,Color.WHITE);
        gui_fields[29] = new GUI_Street("t",helper.getFieldData(30,3) + "kr","d","20",Color.LIGHT_GRAY,Color.black);
        gui_fields[30] = new GUI_Jail();gui_fields[30].setSubText("Go to jail!");
        gui_fields[31] = new GUI_Street("t",helper.getFieldData(32,3) + "kr","d","20",Color.YELLOW,Color.black);
        gui_fields[32] = new GUI_Street("t",helper.getFieldData(33,3) + "kr","d","20",Color.YELLOW,Color.black);
        gui_fields[33] = new GUI_Chance();gui_fields[33].setSubText("Chance card");
        gui_fields[34] = new GUI_Street("t",helper.getFieldData(35,3) + "kr","d","20",Color.YELLOW,Color.black);
        gui_fields[35] = new GUI_Shipping("default",helper.getFieldData(36,3) + "kr","d","","20",Color.BLUE,Color.black);
        gui_fields[36] = new GUI_Chance();gui_fields[36].setSubText("Chance card");
        gui_fields[37] = new GUI_Street("t",helper.getFieldData(38,3) + "kr","d","20",Color.magenta,Color.black);
        ...
        gui_fields[39] = new GUI_Street("t",helper.getFieldData(40,3) + "kr","d","20",Color.magenta,Color.black);
